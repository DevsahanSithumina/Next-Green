  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sunlight: { DEFAULT: "hsl(var(--sunlight))", foreground: "hsl(var(--sunlight-foreground))" },
      ...
      backgroundImage: {
        ...
        "gradient-tomato": "var(--gradient-tomato)",
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { opacity: "1", boxShadow: "0 0 20px hsl(var(--tomato) / 0.5)" }, "50%": { opacity: "0.85", boxShadow: "0 0 40px hsl(var(--tomato) / 0.8)" } },
